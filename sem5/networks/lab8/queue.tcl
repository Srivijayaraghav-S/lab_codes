...
#Monitor the queue for link (n0-n1). (for NAM)
 set link [$ns simplex-link $n2 $n3 0.3Mb 2000ms DropTail]
...
#set qmon [$ns monitor-queue $n2 $n3 [open queue.out w] 0.1]
...
# ns queue.tcl
# gawk '{ print $1, $4 }'  qm.out > qm.pre
# gnuplot
# plot "qm.pre" using 1:2 title "Flow 1" with lines
